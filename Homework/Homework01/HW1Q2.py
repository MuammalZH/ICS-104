...
if normName == "1-norm": # i will use the abs function from chapter two
    ...
    print("1-norm distance value =" , oneNorm) # i can print it without define the oneNorm function but ithink this way is cleaner
    ...
    print("1-norm distance value =" , twoNorm)  # i can print it without define the twoNorm function but ithink this way is cleaner
    ...
    print("infinity norm distance value = " , infinityNorm) 
